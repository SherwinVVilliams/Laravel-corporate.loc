...
<![endif]-->
    ...
    <head>
        ...
        <!-- [favicon] begin -->
        <link rel="shortcut icon" type="image/x-icon" href="/pink/images/favicon.ico" />
        <link rel="icon" type="image/x-icon" href="/pink/images/favicon.ico" />
        <!-- Touch icons more info: http://mathiasbynens.be/notes/touch-icons -->
        <!-- For iPad3 with retina display: -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/pink/css/apple-touch-icon-144x.png" />
        <!-- For first- and second-generation iPad: -->
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/pink/css/apple-touch-icon-114x.png" />
        <!-- For first- and second-generation iPad: -->
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="/pink/css/apple-touch-icon-72x.png" />
        <!-- For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
        <link rel="apple-touch-icon-precomposed" href="/pink/css/apple-touch-icon-57x.png" />
        <!-- [favicon] end -->
        ...
        <script type="text/javascript" src="/pink/js/adminScript.js"></script>
        <script type="text/javascript" src = "/pink/js/ckeditor/ckeditor.js"></script>
        <script type="text/javascript" src = "/pink/js/bootstrap-filestyle.min.js"></script>
                ...
                <div id="header" class="group">
                    ...
                    <div class="group inner">
                        ...
                        <div id="logo" class="group">
                            <a href="{{ route('home')}}" title="Pink Rio"><img src="/pink/images/logo.png" title="Pink Rio" alt="Pink Rio" /></a>
                        </div>
                        <!-- END LOGO -->
