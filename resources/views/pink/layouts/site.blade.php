...
<![endif]-->
    ...
    <head>
        ...
        <meta name = 'description'  content="{{ $meta_desc ? $meta_desc : 'Pink' }}">
        <meta name = 'keywords' = content="{{ $keywords ? $keywords : 'Pink' }} ">
        ...
        <script type="text/javascript" src="/pink/js/myscript.js"></script>
    ...
    <body class="no_js responsive {{ Route::currentRouteName() == 'home' ? 'page-template-home-php' : ''}} stretched">
        ...
        <div class="bg-shadow">
            ...
            <div id="wrapper" class="group">
                ...
                <!-- START SLIDER -->
				@yield('slider')
                <div class = "wrap_result" style = "    background-color: #f0f2f0;
